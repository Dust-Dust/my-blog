<template>
  <div id="edit-blog">
    ...
    <form v-if="!submmited">
        ...
        <!-- 编辑博客按钮 -->
        <button v-on:click.prevent="post" class="submmitblog">编辑博客</button>
        <!-- prevent:防止提交后刷新页面 -->
    </form>
...
// https://jsonplaceholder.typicode.com/posts
  ...
  methods: {
      ...
      post:function(){
          this.$http.put('https://my-blog-8f4cc-default-rtdb.firebaseio.com/posts/' + this.id + ".json",this.blog)
                .then(function(data){
                    // console.log(data);
